...
function FooterLink({ href = "#", children }) {
  return (
    <a
      href={href}
      className="block text-[13px] text-[#94A3B8] hover:text-[#111] transition-colors duration-150 leading-none"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            <a
              ...
              style={{ fontFamily: "Syne, sans-serif", fontWeight: 800, fontSize: 22, color: "#111", textDecoration: "none", letterSpacing: "-0.5px" }}
            >
              Clean<span style={{ opacity: 0.3 }}>Hub</span>
            </a>
      ...
      <div className="border-t border-[#F1F5F9]">
        <div className="max-w-[1280px] mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-5">
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((label) => (
              <a
                key={label}
                href="#"
                className="text-[12px] text-[#CBD5E1] hover:text-[#94A3B8] transition-colors duration-150"
                style={{ fontFamily: "DM Sans, sans-serif" }}
              >
                {label}
              </a>
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-[12px] text-[#CBD5E1] hover:text-[#111] transition-colors duration-150 group"
            style={{ fontFamily: "DM Sans, sans-serif" }}
          >
            Back to top
            <ArrowUpRight
